...
{
	//2015.4.10 - php 
	if(this->representation->GetSegmentBase() && this->representation->GetSegmentBase()->GetInitialization())
		return this->representation->GetSegmentBase()->GetInitialization()->ToSegment(this->baseUrls);
