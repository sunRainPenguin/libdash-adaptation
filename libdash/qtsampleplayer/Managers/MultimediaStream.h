...
#include "../libdashframework/Buffer/VideoFrame.h"
#include "../libdashframework/Buffer/AudioSamples.h"
#include <QImage>
    ...
    namespace managers
    {
        class MultimediaStream : public libdash::framework::input::IDASHManagerObserver, public libdash::framework::buffer::IBufferObserver
        {
            public:
                ...
                void        AddFrame                (VideoFrame *frame);			//2015.4.8 - php
                VideoFrame*     GetFrame                ();					//2015.4.10 - php

                void                                    AddSamples  (libdash::framework::buffer::AudioSamples* samples);
                libdash::framework::buffer::AudioSamples* GetSamples  ();
            ...
            private:
                ...
                libdash::framework::buffer::Buffer<libdash::framework::buffer::VideoFrame>          *frameBuffer;			//2015.4.8 - php
                libdash::framework::buffer::Buffer<libdash::framework::buffer::AudioSamples> *sampleBuffer;				//2015.4.18 - php
